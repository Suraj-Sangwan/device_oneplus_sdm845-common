...
import com.octavi.device.DeviceSettings.Constants;
import com.octavi.device.DeviceSettings.DeviceSettings;
import com.octavi.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public static final String CLIENT_PACKAGE_PATH = "/data/misc/octavi/client_package_name";
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("com.octavi.device.DeviceSettings",
