...
*
*/
package com.octavi.device.DeviceSettings;
...
import com.octavi.device.DeviceSettings.FileUtils;
import com.octavi.device.DeviceSettings.doze.DozeSettingsActivity;
import com.octavi.device.DeviceSettings.preferences.ProperSeekBarPreference;
import com.octavi.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import com.octavi.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import com.octavi.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), com.octavi.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
